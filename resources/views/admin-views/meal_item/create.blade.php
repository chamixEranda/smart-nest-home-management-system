...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{ translate('messages.add_new_meal') }}
            </span>
        </h1>
    </div>
    <!-- End Page Header -->
    <div class="card">
        <div class="card-body">
            {!! Form::open(['route' => 'admin.meal-item.store', 'method' => 'post', 'files' => true, 'autocomplete' => 'off']) !!}
                @csrf
                <div class="form-group mb-3">
                    <center class="py-3 my-auto">
                        <img class="img--200" id="viewer"
                            onerror="this.src='{{ asset('assets/admin/images/img2.jpg') }}'" src="" alt="logo image" />
                    </center>
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <select class="form-select" name="meal_category_id" aria-label="Default select example"
                            required>
