...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{ translate('messages.expense_categories') }}
            </span>
        </h1>
    </div>
    <!-- End Page Header -->
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <h5 class="card-title fw-semibold mb-4">{{ translate('messages.expense_category_list') }}</h5>
                </div>
            </div>
        </div>
        <div class="card-body">
            <table id="account-table" class="table">
                <thead>
                    <tr>
                        ...
                        <th class="border-0">{{translate('messages.colour')}}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>{{ $key }}</td>
                        <td>{{ $category->user->f_name.' '.$category->user->l_name }}</td>
                        <td>{{ $category->name }}</td>
